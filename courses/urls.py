...
from .views import all_courses, archive_course, create_course, add_video, delete_enrollment, edit_course, enroll_student, list_enrollments, mark_video_complete, student_courses, list_courses
