...
function WatchCourse() {
    ...
    const watermarkText =
        `${fullName} • ${currentUser?.email || ''} • ${currentTime}`;
        ...
        <div className="min-h-screen bg-slate-950 text-white flex">
            ...
            <div className="flex-1 overflow-y-auto">
                ...
                <div className="p-8">
                    ...
                    {/* DESCRIPTION */}
                    <div className="rounded-2xl border border-white/10 bg-slate-900/40 backdrop-blur-xl p-6 mb-8">
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <a
                            ...
                            className="rounded-xl bg-red-600 hover:bg-red-700 px-6 py-3 font-semibold transition"
                        >
                            Watch on YouTube
                        </a>
                        ...
                        {!currentVideo.completed && (
                            ...
                            <button
                                ...
                                className="rounded-xl border border-emerald-400 hover:bg-emerald-400/10 px-6 py-3 font-semibold transition disabled:opacity-50"
                            >
                        ...
                        {currentVideo.completed && (
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <div className="rounded-xl bg-emerald-500/15 border border-emerald-400 px-6 py-3 font-semibold text-emerald-300">
                                ...
                                {nextVideo && (
                                    ...
                                    <button
                                        onClick={() =>
                                            navigate(
                                                `/watch-course/${courseId}/${nextVideo.id}`
                                            )
                                        }
                                        className="rounded-xl bg-cyan-500 hover:bg-cyan-600 px-6 py-3 font-semibold text-white transition"
                                    >
                                        Next Lesson →
                                    </button>
